 ...
 * 类型容器。
 */
const typeContainer: Record<string, Constructor> = {};
 ...
 * 声明为 Bean 容器托管的装饰器。
 */
export function Component(construct: Constructor) {
...
*/
function createInstance(construct: Constructor, dependencyChain: Function[] = []): any {
  ...
  let bean = new construct(...paramBeans);
